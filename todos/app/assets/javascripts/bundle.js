...
exports.createTodo = exports.fetchTodos = exports.receiveTodo = exports.receiveTodos = exports.RECEIVE_TODO = exports.RECEIVE_TODOS = undefined;

var _todo_api_util = __webpack_require__(81);

var APIUtils = _interopRequireWildcard(_todo_api_util);
...
var fetchTodos = exports.fetchTodos = function fetchTodos() {
  return function (dispatch) {
    APIUtils.fetchTodos().then(function (todos) {
...
var createTodo = exports.createTodo = function createTodo(todo) {
  return function (dispatch) {
    APIUtils.createTodo(todo).then(function (todoResponse) {
      return dispatch(receiveTodo(todoResponse));
    });
  };
};
...
var _todo_actions = __webpack_require__(12);
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    window.allTodos = (0, _selectors.allTodos)(window.getState());
...
var _root_reducer = __webpack_require__(58);
...
var _thunk = __webpack_require__(82);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(11), __webpack_require__(53)(module)))
...
var _todos_reducer = __webpack_require__(59);
...
var _todo_list_container = __webpack_require__(76);
...
var _todo_list = __webpack_require__(77);
...
var _todo_list_item = __webpack_require__(78);

var _todo_list_item2 = _interopRequireDefault(_todo_list_item);

var _todo_form = __webpack_require__(79);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          todos.map(function (todo) {
            return _react2.default.createElement(_todo_list_item2.default, { todo: todo, key: todo.title.concat(todo.id) });
          })
        ),
        _react2.default.createElement(_todo_form2.default, { someCallback: createTodo })
      );
    }
  }]);
